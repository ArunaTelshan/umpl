  ...
  <div class="card col-md-6 border-secondary">
    <div class="card-body">
	 ...
	 <div class="progress mb-3" style="height: 2px;">
      ...
      <p class="card-text"><small class="text-muted">Total Transactions: </small> <span id="t_count" class="badge badge-dark"></span>
...
<!----------------------------------- CASH FORM ----------------------------------->
		...
		<div class="form-group row">
			<label for="c_name" class="col-sm-2 col-form-label">Category</label>
			<div class="col-sm-10">
...
<div class="card">
  <div class="card-header">
    ...
    <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
      <li class="nav-item">
        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Petty cash table</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">IOU Table</a>
      </li>
    </ul>
...
<!--		<h5 class="card-title">Special title treatment</h5>-->
		<table id="cash_table" class="table table-bordered table-hover table-sm">
		  <thead>
			<tr>
		...
		// Cash Table ========================================
			...
			if($tb_cash_count > 0){
				while($result  = mysqli_fetch_assoc($tb_cash_query)){
					...
					echo '<tr><td>'.$result["c_no"].'</td>';
					echo '<td>'.$result["c_name"].'</td>';
					echo '<td>'.$result["c_date"].'</td>';
					echo '<td>'.$result["c_receive"].'</td>';
	  ...
	  <div class="card-body">   
		<table id="iou_table" class="table table-bordered table-hover table-sm">
		  <thead>
			<tr>
			  <th scope="col">Name</th>
			  <th scope="col">Date</th>
		...
		// IOU Table ========================================
			...
			$tb_iou = "SELECT `i_emp`,`i_date`,SUM(i_amt) AS i_amt FROM `iou` GROUP BY `i_emp`, MONTH(i_date)";    
